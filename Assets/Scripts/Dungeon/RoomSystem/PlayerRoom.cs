...
public class PlayerRoom : RoomGenerator
{
    ...
    public override List<GameObject> ProcessRoom(Vector2Int roomCenter, HashSet<Vector2Int> roomFloor, HashSet<Vector2Int> roomFloorNoCorridors)
    {
        ...
        Vector3 playerSpawnPoint = new Vector3(roomCenter.x, roomCenter.y);
...
public abstract class PlacementData
{
    ...
    [Min(0)] public int minQuantity = 0;
    
    [Min(0)][Tooltip("Max is inclusive")] public int maxQuantity = 0;
